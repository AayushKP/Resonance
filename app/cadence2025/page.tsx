...
export default function Cadence() {
  ...
  return (
    <motion.div 
      ...
      className="min-h-screen text-white pt-24 md:pt-32 pb-10 px-4 sm:px-6 lg:px-8 overflow-y-auto relative"
    >
                  ...
                  {pocs.map((poc, index) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-3 sm:gap-4">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-br from-gray-600 to-gray-800 flex items-center justify-center flex-shrink-0">
